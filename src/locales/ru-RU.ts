...
"remain": "Осталось:",
  ...
  "infoStar": "Поскольку средства ограничены, просьба не злоупотреблять ими! Если жетоны исчерпаны, пополнение должно быть завершено не позднее 24:00 следующего дня.",
